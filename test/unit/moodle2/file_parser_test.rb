...
module Moodle2
  class FileParserTest < MiniTest::Unit::TestCase
    ...
    def test_files_parsing
      ...
      file = files[0]
      file.id.must_equal('15')
      file.content_hash.must_equal('a0f324310c8d8dd9c79458986c4322f5a060a1d9')
      file.context_id.must_equal('22')
      file.component.must_equal('mod_resource')
      ...
      file.time_created.must_equal('1392903875')
      file.time_modified.must_equal('1392903895')
      file.source.must_equal('Server files: Miscellaneous/Sample Course/My Sample Page (Page)/Page content/smaple_gif.gif')
      file.author.must_equal('Admin User')
      file.license.must_equal('allrightsreserved')
      file.sort_order.must_equal('1')
