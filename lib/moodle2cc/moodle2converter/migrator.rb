  ...
  class Migrator
    ...
    def migrate
      @extractor.extract do |moodle_course|
        ...
        cc_course.assessments += convert_assessments(moodle_course.quizzes, moodle_course.choices, moodle_course.questionnaires)
    ...
    def convert_assessments(quizzes, choices, questionnaires)
